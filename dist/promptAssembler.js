...
function listOrEmpty(ctx, key, joiner = ", ") {
    const arr = ctx.tokens[key] || [];
    return arr.length ? arr.join(joiner) : "";
}
function rarityAdjective(r) {
    switch (r) {
...
export function assemblePrompt(ctx) {
...
export function assembleStyle(ctx) {
    const parts = [];
...
export function makeTagsHeader(ctx) {
    const basePairs = [
        ['genre', ctx.genre],
        ['rarity', ctx.rarity],
        ['vibe', ctx.vibe],
